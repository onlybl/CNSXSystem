...
<body>
		<div id="">
			...
			<table class="table table-bordered table-condensed">
			  ...
			  <div>
			      <a href="javascript:showInsert()" type='button' class='btn btn-success'>添加供应商</a>
			  </div>
		    </div>
		</div>
		...
		<div id="insertModel">
			<div id="insertModelContent">
				<h3 align="center" style="color: royalblue">添加供应商</h3>
                    ...
                    <span id="BName" style="color: red; font-size: 10px;"></span>
                    <br>
                    <label for="bankAccount">银行账号</label>
                    <input type="text" class="form-control" id="bankAccount">
                    <span id="account" style="color: red; font-size: 10px;"></span>
                 <br>
