	...
	$.ajax({
		...
		success : function(orderList){
			...
			for(var i=0;i<orderList.length;i++){
				...
				str +="<tr><td>"+order.orderNumber+"</td><td>"+order.orderCreateTime+"</td><td>"+order.depositoryOutAssign+"</td><td>"+order.productName+"</td><td>"+order.customerName+"</td><td>"+order.orderQuantity+"</td><td>"+order.orderTotalPrice+"</td><td>已出库</td><td><a class='btn btn-block btn-default' href='javascript:look(\""+order.orderId+"\");'><span class='glyphicon glyphicon-edit' style='color: rgb(0, 0, 145);'></span>查看详情</a></td></tr>";
			}
	...
	<div style="height: 386px; margin: auto">
		<div style="margin: auto;">
			<ul id="navone" class="nav nav-tabs">
				...
				<li><a
					href="<%=basePath%>view/system/saleManage/unstockedorderList.jsp"
					id="one" title="未完成列表">查看未出库订单列表</a></li>
				<li><a
			...
			<h2>
				<b style="margin-left: 80px;">已出库订单列表</b>
			</h2>
			<hr>
