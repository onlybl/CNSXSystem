...
<body>
	...
	<div class="margin clearfix">
		<div
			style="background-color: rgb(28, 192, 227); height: 50px; text-align: center;">
				...
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a style="color: teal;" data-toggle="tab"
						href="#home" onclick="tobehandle(1)"><i
							class="green fa fa-home bigger-110"></i>&nbsp;待入库物料 <span
				...
				<div class="tab-content">
					...
					<div id="other" class="tab-pane">
						...
						<ul class="search_content list-inline">
							...
							<li><button onclick="searchmaterialin()">
		...
		<div id="editbaseinf">
			<div class="modal-header">
				...
				<h3 class="text-warning">
					<span>物料编号：</span><span style="color: purple;" id="materialNo">materialNo</span>
				</h3>
				<h3 class="text-warning">
					<span>物料名称：</span><span style="color: purple;" id="productionName">materialName</span>
					<span style="margin-left: 20px">库存数量：</span><span
						style="color: purple;" id="purchaseQuantity">Totalcount</span>
				</h3>
				<h3 class="text-warning">
					<span>仓库编号：</span><span style="color: purple;"
						id="materialStorehouseNo">warehouseNo</span> <span
						style="margin-left: 20px">仓库联系电话：</span><span
						style="color: purple;" id="materialStorehouseContact">supportHotline</span>
				</h3>
				<h3 class="text-info">
					<span>仓库地址：</span>
				</h3>
				<input type="hidden" id="materialStorehouseId" value=''> <input
					type='text' class='form-control' id="materialStorehouseAddress"
					value='materialStorehouseAddress' placeholder="仓库地址不能为空......"
					style="color: black" />
...
<script type="text/javascript"
	src="view/system/mywarehouse/materialin.js"></script>
</html>
